...
protected:
  ...
  // TODO define your private methods and variables here
  std::vector<Vec2d> traj; //define a vector to describe trajectory

  double position;     //define position
  double velocity;     //define velocity

  double position_eqm; //define position in equilibrium
  double velocity_eqm; //define velocity in equilibrium

  int time;       //define current time;
