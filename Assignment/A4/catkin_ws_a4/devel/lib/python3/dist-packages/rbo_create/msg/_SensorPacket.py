...
"""autogenerated by genpy from rbo_create/SensorPacket.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.wheeldropCaster, _x.wheeldropLeft, _x.wheeldropRight, _x.bumpLeft, _x.bumpRight, _x.wall, _x.cliffLeft, _x.cliffFronLeft, _x.cliffFrontRight, _x.cliffRight, _x.virtualWall, _x.infraredByte, _x.advance, _x.play, _x.distance, _x.angle, _x.chargingState, _x.voltage, _x.current, _x.batteryTemperature, _x.batteryCharge, _x.batteryCapacity, _x.wallSignal, _x.cliffLeftSignal, _x.cliffFrontLeftSignal, _x.cliffFrontRightSignal, _x.cliffRightSignal, _x.homeBase, _x.internalCharger, _x.songNumber, _x.songPlaying,) = _get_struct_14B2hBHhb7H4B().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_14B2hBHhb7H4B = None
def _get_struct_14B2hBHhb7H4B():
    global _struct_14B2hBHhb7H4B
    if _struct_14B2hBHhb7H4B is None:
        _struct_14B2hBHhb7H4B = struct.Struct("<14B2hBHhb7H4B")
    return _struct_14B2hBHhb7H4B
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
