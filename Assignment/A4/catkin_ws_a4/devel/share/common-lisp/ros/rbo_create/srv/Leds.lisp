...
(cl:defmethod cl:initialize-instance :after ((m <Leds-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leds-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rbo_create-srv:<Leds-request> is deprecated: use rbo_create-srv:Leds-request instead.")))

(cl:ensure-generic-function 'advance-val :lambda-list '(m))
(cl:defmethod advance-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rbo_create-srv:advance-val is deprecated.  Use rbo_create-srv:advance instead.")
  (advance m))

(cl:ensure-generic-function 'play-val :lambda-list '(m))
(cl:defmethod play-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rbo_create-srv:play-val is deprecated.  Use rbo_create-srv:play instead.")
  (play m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rbo_create-srv:color-val is deprecated.  Use rbo_create-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rbo_create-srv:intensity-val is deprecated.  Use rbo_create-srv:intensity instead.")
  (intensity m))
...
(cl:defmethod cl:initialize-instance :after ((m <Leds-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leds-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rbo_create-srv:<Leds-response> is deprecated: use rbo_create-srv:Leds-response instead.")))
