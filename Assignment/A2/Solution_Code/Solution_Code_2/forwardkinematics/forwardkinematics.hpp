...
public:
  ...
  //(corrected) link lengths  (edit Vincent: had to move the declaration here, otherwise it wouldn't compile)
  static constexpr float l1 = 0.4318 - 0.0203; //length of link 1
  static constexpr float l2 = 0.4331; //length of link 2
  static constexpr float l3 = 0.055; //length of link 3
