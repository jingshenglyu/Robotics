...
void ForwardKinematicsPuma2D::computeT0_E()
{
   ...
   // define the angles
   double a1 = angles[0], a12 = angles[0]+angles[1], a123 = angles[0]+angles[1]+angles[2];

   //row vector
   T0_E[0][0] = sin(a123);
   T0_E[0][1] = cos(a123);
   T0_E[0][2] = 0.0;
   T0_E[0][3] = cos(a1)*l1+sin(a12)*l2+sin(a123)*l3;

   //row vector
   T0_E[1][0] = -cos(a123);
   T0_E[1][1] = sin(a123);
   T0_E[1][2] = 0.0;
   T0_E[1][3] = sin(a1)*l1-cos(a12)*l2-cos(a123)*l3;
...
void ForwardKinematicsPuma2D::computeF()
{
   ...
   F[0] = cos(a1)*l1+sin(a12)*l2+sin(a123)*l3;; //x
   F[1] = sin(a1)*l1-cos(a12)*l2-cos(a123)*l3; //y
   F[2] = a123-PI/2.0; //alpha

   //OR:
      /* the end-effector position in end-effector frame: pos_E=[0,0,0]
...
void ForwardKinematicsPuma2D::computeJ()
{
   ...
   // define the angles
   double a1 = angles[0], a12 = angles[0]+angles[1]-PI/2, a123 = angles[0]+angles[1]-PI/2+angles[2];

   //row vector
   J[0][0] = -sin(a1)*l1+cos(a12)*l2+cos(a123)*l3;
   J[0][1] = cos(a12)*l2+cos(a123)*l3;
   J[0][2] = cos(a123)*l3;

   //row vector
   J[1][0] = cos(a1)*l1-sin(a12)*l2-sin(a123)*l3;
   J[1][1] = -sin(a12)*l2-sin(a123)*l3;
   J[1][2] = -sin(a123)*l3;
...
int main()
{
 ...
 fk->setJoints(2.23,1.14,3.14/3); //example, try out different value
